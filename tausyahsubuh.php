...
<body>
   ...
   <div class="galangdana">
	  ...
	  <div class="form-group">
	  	...
	  	<small id="emailHelp" class="form-text text-muted">Masukkan nominal donasi tanpa titik Rp 10000(contoh: 15000, 50000) 
   				</small>
...
<?php 
	...
	if (isset($_POST['btn'])) {
		...
		$query=mysqli_query($conn,"INSERT INTO `ptausiyah`(`id`, `nama`, `tempat`, `waktu`, `dana`) VALUES ('','$nama','$tempat','$waktu','$dana')");
